        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--spacing-6)' }}>
            ...
            <div className="glass-panel" style={{ 
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start', marginBottom: 'var(--spacing-4)' }}>
                    <div style={{ flex: 1 }}>
                        ...
                        <p style={{ color: 'var(--text-muted)', fontSize: 'var(--font-size-base)', marginBottom: 'var(--spacing-2)' }}>
                            Postmortem for{' '}
                            <Link
            ...
            {timelineEvents.length > 0 && (
                <PostmortemTimeline 
                    ...
                    incidentStartTime={postmortem.incident.resolvedAt ? undefined : new Date(postmortem.createdAt)}
            ...
            {Object.keys(impactMetrics).length > 0 && (
                <PostmortemImpactMetrics metrics={impactMetrics} />
            )}
