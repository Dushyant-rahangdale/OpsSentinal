    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--spacing-6)' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <div>
                    <h2 style={{ fontSize: 'var(--font-size-xl)', fontWeight: 'var(--font-weight-bold)', marginBottom: 'var(--spacing-2)' }}>
                        Saved Searches
                    </h2>
            ...
            <Card>
                <div style={{ padding: 'var(--spacing-5)' }}>
                    ...
                    {myPresets.length === 0 ? (
                        <p style={{ color: 'var(--text-muted)', fontSize: 'var(--font-size-sm)', padding: 'var(--spacing-4)' }}>
            ...
            {showCreateModal && (
                ...
                >
                    <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 'var(--spacing-4)' }}>
                        ...
                        {/* Filter Criteria */}
                        <div style={{ border: '1px solid var(--border)', borderRadius: 'var(--radius-md)', padding: 'var(--spacing-4)' }}>
                            <h4 style={{ fontSize: 'var(--font-size-base)', fontWeight: 'var(--font-weight-semibold)', marginBottom: 'var(--spacing-3)' }}>
                                Filter Criteria
                            </h4>
            ...
            <div style={{ flex: 1 }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--spacing-2)', marginBottom: 'var(--spacing-1)' }}>
                    ...
                    {preset.isShared && !preset.isPublic && (
                        <Badge variant="default" size="sm">Shared</Badge>
                    )}
                    {preset.usageCount > 0 && (
                ...
                {showCreator && (
                    <p style={{ fontSize: 'var(--font-size-xs)', color: 'var(--text-muted)', marginTop: 'var(--spacing-1)' }}>
