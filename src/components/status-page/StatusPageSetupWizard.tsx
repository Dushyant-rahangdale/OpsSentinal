                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 'var(--spacing-2)' }}>
                    {STEPS.map((step) => (
                        ...
                        >
                            ...
                            <div style={{ fontSize: 'var(--font-size-xs)', color: step.id <= currentStep ? 'var(--text-primary)' : 'var(--text-muted)' }}>
                                {step.title}
                            </div>
                        </div>
                    ))}
                ...
                <div style={{ padding: 'var(--spacing-6)' }}>
                    ...
                    {currentStep === 3 && (
                        <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--spacing-4)' }}>
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--spacing-2)', maxHeight: '400px', overflowY: 'auto' }}>
                                ...
                                {allServices.length === 0 && (
                                    <p style={{ fontSize: 'var(--font-size-sm)', color: 'var(--text-muted)', textAlign: 'center', padding: 'var(--spacing-4)' }}>
                    ...
                    {currentStep === 4 && (
                        <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--spacing-4)' }}>
                            <div style={{ padding: 'var(--spacing-4)', background: '#f9fafb', borderRadius: 'var(--radius-md)' }}>
                            ...
                            <div style={{ padding: 'var(--spacing-4)', background: '#fef3c7', border: '1px solid #fde68a', borderRadius: 'var(--radius-md)' }}>
                    ...
                    {/* Navigation Buttons */}
                    <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: 'var(--spacing-6)', paddingTop: 'var(--spacing-4)', borderTop: '1px solid #e5e7eb' }}>
                        <div>
                            {onSkip && (
                                <Button
                                    type="button"
