...
import { Card, FormField, Switch, Button } from '@/components/ui';
                ...
                <div style={{ padding: 'var(--spacing-6)' }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 'var(--spacing-3)' }}>
                        {Object.entries(PRIVACY_PRESETS).map(([key, preset]) => (
                            ...
                            >
                                <div style={{ fontWeight: '600', marginBottom: 'var(--spacing-1)', color: localSettings.privacyMode === key ? 'var(--primary)' : 'var(--text-primary)' }}>
                                    {preset.label}
                                </div>
                ...
                <div style={{ padding: 'var(--spacing-6)' }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--spacing-4)' }}>
                        ...
                        <FormField
                            ...
                            onChange={(e) => updateSetting('dataRetentionDays', e.target.value ? parseInt(e.target.value) : null)}
                        ...
                        {customFields.length > 0 && (
                            <div>
                                ...
                                {localSettings.showCustomFields && (
                                    <div style={{ marginTop: 'var(--spacing-3)', padding: 'var(--spacing-3)', background: '#f9fafb', borderRadius: 'var(--radius-md)' }}>
