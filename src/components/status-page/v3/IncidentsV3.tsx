...
function IncidentCard({
  ...
  return (
    <details className="status-v3-incident" data-status={token} open={defaultOpen}>
      <summary className="status-v3-incident__summary">
        <span className="status-v3-incident__summary-main">
          ...
          <span className="status-v3-incident__title">{incident.title ?? 'Service incident'}</span>
      ...
      <div className="status-v3-incident__body">
        ...
        {incident.postmortem &&
          (postmortemHref ? (
            <a className="status-v3-incident__pir" href={postmortemHref(incident.postmortem.id)}>
              {incident.postmortem.title ?? 'View post-incident review'} ΓåÆ
            </a>
          ) : (
...
export default function IncidentsV3({
  ...
  if (incidents.length === 0) {
    return (
      <section
        className="status-v3-incidents status-panel"
