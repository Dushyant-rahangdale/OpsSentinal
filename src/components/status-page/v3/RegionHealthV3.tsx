...
/** Region health from V3 aggregation ΓÇö the frontend never computes a region's worst status. */
export default function RegionHealthV3({ regions }: { regions: PublicRegionStatus[] }) {
  if (regions.length === 0) return null;
  return (
    <section className="status-v3-regions status-panel" aria-labelledby="status-v3-regions-heading">
