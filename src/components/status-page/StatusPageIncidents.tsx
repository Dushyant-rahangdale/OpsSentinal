...
export default function StatusPageIncidents({
  incidents,
  privacySettings,
  ...
  const getResolutionNote = (events: IncidentEvent[]) => {
    const resolutionEvent =
      events.find(event => /^resolved:/i.test(event.message)) ||
      ...
      {paginatedIncidents.length === 0 ? (
        <div
          style={{
            padding: '5rem 2rem',
            background:
              'linear-gradient(135deg, var(--status-panel-bg, #ffffff) 0%, var(--status-panel-muted-bg, #f8fafc) 100%)',
                  ...
                  >
                    <div style={{ flex: 1, minWidth: 0, paddingLeft: 'clamp(0.75rem, 2vw, 1rem)' }}>
                                  ...
                                  getRegionList(incident.service?.region).map(region => (
                                    <span
                                      ...
                                      style={{
                                        ...
                                        border:
                                          '1px solid var(--status-panel-muted-border, #e2e8f0)',
                                        fontWeight: '600',
                                        color: 'var(--status-text-muted, #6b7280)',
                                        fontSize: '0.75rem',
                                      }}
                              ...
                              {incident.resolvedAt && (
                                <>
                                  ...
                                  >
                                    ...
                                    Resolved{' '}
                                    {formatDateTime(incident.resolvedAt, browserTimeZone, {
                                      format: 'short',
                                    })}
                                  </span>
                                </>
                      ...
                      <div style={{ display: 'flex', gap: '0.75rem', marginTop: '0.75rem' }}>
                        {privacy.showIncidentUrgency && <span>{incident.urgency} urgency</span>}
                        {privacy.showIncidentDetails && <span>Incident {incident.id}</span>}
                      </div>
                      {!privacy.showAffectedServices &&
                        privacy.showServiceRegions &&
                        getRegionList(incident.service?.region).length > 0 && (
                          <div
                            style={{
                              display: 'flex',
                              flexWrap: 'wrap',
                      ...
                      {showPostmortemLink && (
                        <a
                          ...
                          style={{
                            ...
                            border:
                              '1px solid color-mix(in srgb, var(--status-primary, #2563eb) 40%, #ffffff)',
                            textDecoration: 'none',
                            display: 'inline-flex',
                            alignItems: 'center',
                            gap: '0.35rem',
                  ...
                  {!privacy.showIncidentDetails && (
                    ...
                    >
                      ...
                      <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                        ...
                        {incident.acknowledgedAt && (
                          ...
                          >
                            ...
                            <span>
                              {formatDateTime(incident.acknowledgedAt, browserTimeZone, {
                                format: 'short',
                              })}
                            </span>
                          </div>
                      ...
                      {resolutionNote && (
                        ...
                        >
                          <span style={{ fontWeight: '600', color: 'var(--status-text, #111827)' }}>
                            Resolution:
                          </span>{' '}
                          {resolutionNote}
                        </div>
                  ...
                  {privacy.showIncidentDetails && isExpanded && timelineEvents.length > 0 && (
                    <div
                      style={{
                        ...
                        paddingLeft: '1rem',
                        background:
                          'linear-gradient(90deg, var(--status-panel-muted-bg, #f8fafc) 0%, transparent 100%)',
                        borderRadius: '0.5rem',
                        padding: '1.5rem 1rem',
                      }}
                    >
                      ...
                      >
                        <div
                          style={{
                            ...
                            boxShadow:
                              '0 0 0 3px color-mix(in srgb, var(--status-primary, #3b82f6) 20%, transparent)',
                          }}
                        ></div>
                        Timeline Updates
                      </h4>
                          ...
                          >
                            ...
                            {index < timelineEvents.length - 1 && (
                              <div
                                style={{
                                  ...
                                  width: '2px',
                                  background:
                                    'linear-gradient(180deg, var(--status-primary, #3b82f6) 0%, #e5e7eb 100%)',
                                }}
                              />
                            )}
                            {/* Timeline dot */}
                            <div
                              style={{
                                ...
                                borderRadius: '50%',
                                background:
                                  'linear-gradient(135deg, var(--status-primary, #3b82f6) 0%, var(--status-primary-hover, #2563eb) 100%)',
                                border: '3px solid white',
                                boxShadow:
                                  '0 0 0 2px var(--status-primary, #3b82f6), 0 2px 12px color-mix(in srgb, var(--status-primary, #3b82f6) 35%, transparent)',
                                marginTop: '0.25rem',
                                flexShrink: 0,
                                zIndex: 1,
                                transition: 'all 0.2s ease',
                              ...
                              onMouseEnter={e => {
                                ...
                                e.currentTarget.style.boxShadow =
                                  '0 0 0 3px var(--status-primary, #3b82f6), 0 4px 16px color-mix(in srgb, var(--status-primary, #3b82f6) 45%, transparent)';
                              }}
                              onMouseLeave={e => {
                                e.currentTarget.style.transform = 'scale(1)';
                                e.currentTarget.style.boxShadow =
                            ...
                            <div
                              style={{
                                flex: 1,
                                paddingBottom: index < timelineEvents.length - 1 ? '1rem' : '0',
                              }}
                            >
                              <p
                                style={{
