...
export default function AssigneeSection({
            ...
            <div style={{ marginBottom: '1.5rem' }}>
                ...
                {isReassigning ? (
                    ...
                    <div
                        ...
                        onMouseLeave={(e) => {
                            e.currentTarget.style.borderColor = assignee ? 'rgba(211,47,47,0.2)' : 'var(--border)';
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                            {assignee ? (
                                ...
                                <>
                                    ...
                                    <div style={{ fontWeight: 500, color: 'var(--text-muted)', fontSize: '0.95rem', fontStyle: 'italic' }}>
                                        Unassigned
                                    </div>
                                </>
                            )}
    ...
    if (isReassigning) {
        return (
            <div onClick={(e) => e.stopPropagation()} style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', minWidth: '200px' }}>
                <select
                    defaultValue={assigneeId || ''}
                    onChange={(e) => {
                        if (e.target.value) {
