...
export default function MobileNotificationsClient() {
    ...
    const fetchNotifications = useCallback(async () => {
        ...
        try {
            ...
            logger.error('mobile.notifications.fetch_failed', { component: 'MobileNotificationsClient', error });
    ...
    const handleMarkAllRead = async () => {
        ...
        try {
            ...
            logger.error('mobile.notifications.mark_all_failed', { component: 'MobileNotificationsClient', error });
    ...
    const handleMarkRead = async (notificationId: string) => {
        ...
        try {
            ...
            logger.error('mobile.notifications.mark_failed', { component: 'MobileNotificationsClient', error });
    ...
    return (
        <div className="mobile-notifications-page">
            ...
            {errorMessage && (
                <div className="mobile-notifications-error">{errorMessage}</div>
            )}
