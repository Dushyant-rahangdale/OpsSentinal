...
const iconTeams = (
    <svg viewBox="0 0 24 24" aria-hidden="true">
        ...
        <path d="M3 20c0-3 3-5 5-5s5 2 5 5" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
        <path d="M13 20c0-2.5 2.5-4.5 5-4.5 1.5 0 3 .5 4 1.5" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
    </svg>
);
...
const iconUsers = (
    <svg viewBox="0 0 24 24" aria-hidden="true">
        ...
        <path d="M5 20c0-3.5 3-6 7-6s7 2.5 7 6" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
    </svg>
);
...
const iconSchedules = (
    <svg viewBox="0 0 24 24" aria-hidden="true">
        ...
        <path d="M8 14h4M8 17h8" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
    </svg>
);
...
const iconAnalytics = (
    <svg viewBox="0 0 24 24" aria-hidden="true">
        ...
        <path d="M8 15l3-4 3 2 4-6" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
);
...
const iconStatus = (
    <svg viewBox="0 0 24 24" aria-hidden="true">
        <path d="M4 12h4l2-4 4 8 2-4h4" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
);

const iconSettings = (
    <svg viewBox="0 0 24 24" aria-hidden="true">
        <path d="M12 8a4 4 0 1 0 0 8 4 4 0 0 0 0-8Z" fill="none" stroke="currentColor" strokeWidth="1.8" />
        <path d="M4 12h2M18 12h2M12 4v2M12 18v2M6.5 6.5l1.4 1.4M16.1 16.1l1.4 1.4M6.5 17.5l1.4-1.4M16.1 7.9l1.4-1.4" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
    </svg>
);
...
const iconHelp = (
    <svg viewBox="0 0 24 24" aria-hidden="true">
        ...
        <path d="M9.5 9a2.5 2.5 0 0 1 4.4 1.5c0 1.5-1.6 2-2.2 2.5-.4.4-.5.8-.5 1.5" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
...
const iconDesktop = (
    <svg viewBox="0 0 24 24" aria-hidden="true">
        <rect x="3" y="5" width="18" height="12" rx="2.5" fill="none" stroke="currentColor" strokeWidth="1.8" />
...
const iconSignOut = (
    <svg viewBox="0 0 24 24" aria-hidden="true">
        <path d="M9 7V5a2 2 0 0 1 2-2h7a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-7a2 2 0 0 1-2-2v-2" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
        <path d="M3 12h12M9 8l4 4-4 4" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
);

export default function MobileMoreContent({ name, email, role }: MobileMoreContentProps) {
    const shortcuts: ShortcutItem[] = [
        { href: '/m/teams', label: 'Teams', description: 'On-call rosters', icon: iconTeams, tone: 'blue' },
        { href: '/m/users', label: 'Users', description: 'Directory & roles', icon: iconUsers, tone: 'teal' },
        { href: '/m/schedules', label: 'Schedules', description: 'Rotations', icon: iconSchedules, tone: 'green' },
        { href: '/m/policies', label: 'Policies', description: 'Escalations', icon: iconPolicies, tone: 'amber' },
    ];

    const resources: ListItem[] = [
        { href: '/m/analytics', label: 'Analytics', description: 'Trends & uptime', icon: iconAnalytics, tone: 'teal' },
        { href: '/m/postmortems', label: 'Postmortems', description: 'Incident reviews', icon: iconPostmortems, tone: 'amber' },
        { href: '/m/status', label: 'Status Page', description: 'Public updates', icon: iconStatus, tone: 'green' },
    ];

    const account: ListItem[] = [
        { href: '/settings/profile', label: 'Settings', description: 'Profile and security', icon: iconSettings, tone: 'slate' },
        { href: '/help', label: 'Help & Documentation', description: 'Guides and support', icon: iconHelp, tone: 'blue' },
    ];

    const actions: ListItem[] = [
        { href: '/api/prefer-desktop', label: 'Switch to Desktop Mode', description: 'Full dashboard view', icon: iconDesktop, tone: 'slate' },
        { href: '/api/auth/signout', label: 'Sign Out', description: 'Sign out of OpsSentinal', icon: iconSignOut, tone: 'red', danger: true },
    ];
