    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent className="w-56" align="end">
        ...
        <DropdownMenuRadioGroup value={currentSort} onValueChange={handleSortChange}>
          ...
          <DropdownMenuRadioItem value="memberCount">Member Count</DropdownMenuRadioItem>
          <DropdownMenuRadioItem value="serviceCount">Service Count</DropdownMenuRadioItem>
        </DropdownMenuRadioGroup>
        <DropdownMenuSeparator />
