...
export default function PresetSelector({
  ...
  const myPresets = presets.filter(
    p => !p.filterCriteria.filter || p.filterCriteria.filter !== 'default'
  );
            ...
            {myPresets.map(preset => (
              <button
                ...
                style={{
                  ...
                  textAlign: 'left',
                  background:
                    selectedPresetId === preset.id ? 'var(--primary-light)' : 'transparent',
                  border: 'none',
                  borderRadius: 'var(--radius-md)',
                  cursor: 'pointer',
                  display: 'flex',
                  ...
                  gap: 'var(--spacing-2)',
                  color:
                    selectedPresetId === preset.id ? 'var(--primary-dark)' : 'var(--text-primary)',
                  transition: 'all 0.2s',
                }}
                onMouseEnter={e => {
