...
export default function TopbarUserMenu({ name, role, email, avatarUrl, gender, userId }: Props) {
  ...
  const finalAvatarUrl = avatarUrl || getDefaultAvatar(gender, userId || 'user');
          ...
          <div className="user-menu-section">
            <Link className="user-menu-item" href="/settings" onClick={() => setOpen(false)}>
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                <path
                  d="M8 0L0 4V8C0 12.4183 3.58172 16 8 16C12.4183 16 16 12.4183 16 8V4L8 0Z"
                  fill="currentColor"
                  fillOpacity="0.6"
                />
                <path
            ...
            <Link className="user-menu-item" href="/help" onClick={() => setOpen(false)}>
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                <path
                  d="M8 0C3.58172 0 0 3.58172 0 8C0 12.4183 3.58172 16 8 16C12.4183 16 16 12.4183 16 8C16 3.58172 12.4183 0 8 0ZM8 12C7.44772 12 7 11.5523 7 11C7 10.4477 7.44772 10 8 10C8.55228 10 9 10.4477 9 11C9 11.5523 8.55228 12 8 12ZM9 8C9 8.55228 8.55228 9 9 9C9.55228 9 10 8.55228 10 8C10 6.34315 8.65685 5 7 5C5.34315 5 4 6.34315 4 8H5C5 7.44772 5.44772 7 6 7C6.55228 7 7 7.44772 7 8V9H9V8Z"
                  fill="currentColor"
                  fillOpacity="0.6"
                />
              </svg>
