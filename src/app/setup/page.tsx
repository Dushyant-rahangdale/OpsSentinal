...
export default async function SetupPage() {
                ...
                <main style={{
                    ...
                    <div className="glass-panel" style={{ maxWidth: '520px', width: '100%', padding: '2.5rem', background: 'white' }}>
                        ...
                        <ul style={{ color: 'var(--text-secondary)', marginBottom: '1.5rem', paddingLeft: '1.5rem' }}>
                            ...
                            <li>If using Docker Compose, run: <code style={{ background: '#f3f4f6', padding: '0.2rem 0.4rem', borderRadius: '4px' }}>docker-compose up -d opssure-db</code></li>
                        </ul>
    ...
    return (
        <main style={{
            ...
            <div className="glass-panel" style={{ maxWidth: '520px', width: '100%', padding: '2.5rem', background: 'white' }}>
                <h1 style={{ fontSize: '1.8rem', fontWeight: 700, marginBottom: '0.35rem' }}>Bootstrapping OpsSure</h1>
                <p style={{ color: 'var(--text-secondary)', marginBottom: '1.5rem' }}>
