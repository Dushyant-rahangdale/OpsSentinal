    ...
    return (
        <>
            ...
            <div style={{
                ...
                <div className="floating-shape" style={{ width: '150px', height: '150px', top: '10%', left: '-50px', animationDelay: '0s' }} />
                <div className="floating-shape" style={{ width: '100px', height: '100px', top: '60%', right: '-30px', animationDelay: '2s' }} />
                <div className="floating-shape" style={{ width: '80px', height: '80px', bottom: '20%', left: '20%', animationDelay: '4s' }} />
                    ...
                    {ssoEnabled && (
                        <>
                            ...
                            <div style={{
                                ...
                                <span style={{ fontSize: '0.8rem', color: 'rgba(148, 163, 184, 0.6)', textTransform: 'uppercase', letterSpacing: '0.05em' }}>or</span>
                                <div style={{ flex: 1, height: '1px', background: 'rgba(148, 163, 184, 0.2)' }} />
                            </div>
                        </>
                    )}
