    ...
    return (
        <>
            ...
            <div style={{
                ...
                <div className="floating-shape" style={{ width: '120px', height: '120px', top: '15%', right: '-40px', animationDelay: '0s' }} />
                <div className="floating-shape" style={{ width: '80px', height: '80px', bottom: '25%', left: '-20px', animationDelay: '3s' }} />
