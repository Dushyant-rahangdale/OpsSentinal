      ...
      >
        <div>
          ...
          <p style={{ color: 'var(--text-secondary)', fontSize: '0.95rem' }}>
            Manage ownership, roles, and service coverage. {adjustedTotalCount}{' '}
            {adjustedTotalCount === 1 ? 'team' : 'teams'} total.
          </p>
        </div>
        <div style={{ display: 'flex', gap: '0.75rem', alignItems: 'center' }}>
          <Link href="/users" className="glass-button" style={{ textDecoration: 'none' }}>
            View Users
          </Link>
        </div>
      </header>
