    ...
    return (
        <main style={{ padding: '1rem' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' }}>
                <div>
                    <h1 style={{ fontSize: '1.8rem', fontWeight: 'bold', color: 'var(--text-primary)' }}>Event Logs</h1>
                    <p style={{ color: 'var(--text-secondary)' }}>Incident lifecycle events and audit trail</p>
                </div>
            </div>
                    ...
                    <table style={{
                        ...
                        <thead style={{ background: '#f9f9f9', borderBottom: '1px solid var(--border)' }}>
                            <tr>
                                ...
                                <th style={{ textAlign: 'left', padding: '1rem', fontWeight: '600', color: 'var(--text-secondary)' }}>Event</th>
                            </tr>
                        </thead>
                        <tbody>
                            {events.map((event) => (
                            ...
                            {events.length === 0 && (
                                <tr>
                                    <td colSpan={4} className="empty-state" style={{ padding: '2rem', textAlign: 'center', color: 'var(--text-muted)' }}>
                                        No events logged yet. Events will appear here when incidents are triggered, acknowledged, or resolved.
                                    </td>
                                </tr>
                            )}
                        </tbody>
