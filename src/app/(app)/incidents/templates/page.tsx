    ...
    return (
        <main>
            <header style={{ marginBottom: '2rem', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: '1.5rem' }}>
                <div style={{ flex: 1 }}>
                    <Link href="/incidents" style={{ color: 'var(--text-muted)', marginBottom: '0.5rem', display: 'inline-block', textDecoration: 'none', fontSize: '0.9rem' }}>
                        ← Back to Incidents
                    </Link>
                    <h1 style={{ fontSize: '2rem', fontWeight: '800', marginBottom: '0.35rem' }}>Incident Templates</h1>
                    <p style={{ color: 'var(--text-secondary)' }}>
                        Pre-configured templates for common incident types. Create incidents faster with templates.
                    </p>
                </div>
                {canManageTemplates && (
                    <Link href="/incidents/templates/create" className="glass-button primary" style={{ textDecoration: 'none', borderRadius: '0px', whiteSpace: 'nowrap' }}>
                        + Create Template
                    </Link>
                )}
            </header>
            ...
            {templates.length === 0 ? (
                <div className="glass-panel" style={{ padding: '3rem', textAlign: 'center', background: '#f9fafb', border: '1px solid var(--border)', borderRadius: '0px' }}>
                    ...
                    {canManageTemplates && (
                        <Link href="/incidents/templates/create" className="glass-button primary" style={{ textDecoration: 'none', borderRadius: '0px' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(350px, 1fr))', gap: '1.5rem' }}>
                    {templates.map((template) => (
                        ...
                        >
                            ...
                            <div style={{ display: 'flex', gap: '0.75rem', marginTop: 'auto', paddingTop: '0.75rem', borderTop: '1px solid var(--border)' }}>
                                <Link
