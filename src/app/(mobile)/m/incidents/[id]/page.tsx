    ...
    return (
        <div className="mobile-dashboard">
            ...
            {incident.description && (
                <div className="mobile-metric-card" style={{ marginBottom: '1rem' }}>
                    <h3 style={{ fontSize: '0.85rem', fontWeight: '700', margin: '0 0 0.5rem' }}>Description</h3>
            ...
            <div className="mobile-metric-card">
                <h3 style={{ fontSize: '0.85rem', fontWeight: '700', margin: '0 0 0.75rem' }}>Recent Activity</h3>
    ...
    return (
        <div style={{
            ...
            <div style={{ textAlign: 'right' }}>
                ...
                {subValue && <span style={{ fontSize: '0.75rem', color: 'var(--text-muted)' }}>{subValue}</span>}
            </div>
        </div>
    );
}
