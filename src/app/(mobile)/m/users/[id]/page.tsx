                    ...
                    <div style={{ flex: 1 }}>
                        ...
                        <div style={{ display: 'flex', gap: '0.5rem', marginTop: '0.5rem' }}>
                            <span style={{
                                ...
                                borderRadius: '6px',
                                background: user.role === 'ADMIN' ? 'var(--badge-warning-bg)' : 'var(--bg-secondary)',
                                color: user.role === 'ADMIN' ? 'var(--badge-warning-text)' : 'var(--text-secondary)',
                            ...
                            <span style={{
                                ...
                                padding: '0.25rem 0.5rem',
                                borderRadius: '6px',
                                background: user.status === 'ACTIVE' ? 'var(--badge-success-bg)' : 'var(--badge-error-bg)',
                                color: user.status === 'ACTIVE' ? 'var(--badge-success-text)' : 'var(--badge-error-text)',
                            }}>
                                {user.status}
                            </span>
                        </div>
