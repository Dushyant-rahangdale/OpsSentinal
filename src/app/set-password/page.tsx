...
export default async function SetPasswordPage({
      ...
      >
        <div className="glass-panel" style={{ padding: '2rem', background: 'white' }}>
          ...
          <p style={{ color: 'var(--text-secondary)' }}>
            Missing invite token. Ask your admin for a new link.
          </p>
        </div>
      </main>
    );
  ...
  const isExpired = record ? record.expiresAt < new Date() : true;
  ...
  return (
    <main
      style={{
        ...
        padding: '2rem',
        background:
          'radial-gradient(circle at top right, rgba(211,47,47,0.18), transparent 45%), radial-gradient(circle at bottom left, rgba(17,24,39,0.08), transparent 45%), #f8fafc',
      }}
    >
      <div
        className="glass-panel"
        style={{ maxWidth: '460px', width: '100%', padding: '2.5rem', background: 'white' }}
      >
