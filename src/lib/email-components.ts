...
/**
 * Email container with responsive layout and OpsSure branding
...
<head>
    ...
    <title>OpsSure Notification</title>
    <!--[if gte mso 9]>
    <xml>
...
/**
 * Branded email header with OpsSure logo and red gradient
                ...
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="left" style="margin: 0;">
                    <tr>
                        ...
                        <td style="vertical-align: middle;">
                            <span class="mobile-logo-name" style="font-size: 24px; font-weight: 700; color: #ffffff; letter-spacing: -0.01em; font-family: 'Space Grotesk', -apple-system, BlinkMacSystemFont, sans-serif; white-space: nowrap;">OpsSure</span>
                        </td>
                    </tr>
                </table>
                <!--[if mso]>
...
/**
 * Status badge with icon - OpsSure branded
 */
...
/**
 * Call-to-action button with OpsSure red gradient
...
/**
 * Alert box for important messages with OpsSure colors
 */
    ...
    <tr>
        <td style="padding: 36px 40px; background: #f3f4f6; border-top: 1px solid #e5e7eb; text-align: center;">
            <p style="margin: 0 0 12px 0; color: #6b7280; font-size: 14px; line-height: 1.6;">
                This is an automated notification from <strong style="color: #d32f2f;">OpsSure</strong> Incident Management.
            </p>
            ${unsubscribeUrl ? `
 ...
 * Shows the Organization Name prominently instead of OpsSure
 * Maintains the premium OpsSure aesthetic
 */
            ...
            <div style="margin-bottom: 32px;">
                ...
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="left" style="margin: 0;">
                    <tr>
                        ...
                        <td style="vertical-align: middle;">
                            <span class="mobile-logo-name" style="font-size: 20px; font-weight: 700; color: #ffffff; letter-spacing: -0.01em; font-family: 'Space Grotesk', -apple-system, BlinkMacSystemFont, sans-serif; white-space: nowrap;">OpsSure</span>
                        </td>
                    </tr>
                </table>
                <!--[if mso]>
    ...
    <tr>
        <td style="padding: 36px 20px; background: #f8fafc; border-top: 1px solid #e5e7eb; text-align: center;">
            ...
            <div style="opacity: 0.8;">
                ...
                <a href="https://opssure.com" target="_blank" style="text-decoration: none; display: inline-block; margin-top: 8px;">
                    <div style="display: flex; align-items: center; justify-content: center; gap: 8px;">
                        ${getOpsGuardLogo(24)}
                        <span style="color: #1f2937; font-size: 16px; font-weight: 700; font-family: 'Space Grotesk', sans-serif; letter-spacing: -0.02em;">OpsSure</span>
                    </div>
                </a>
            </div>
        </td>
...
function getOpsGuardLogo(width: number): string {
    const appUrl = process.env.NEXT_PUBLIC_APP_URL || 'https://opssure.com';
    return `<img src="${appUrl}/logo.png" width="${width}" height="${width}" alt="OpsSure" style="display: block; width: ${width}px; height: ${width}px; border: 0; outline: none; text-decoration: none; -ms-interpolation-mode: bicubic;" />`;
}
